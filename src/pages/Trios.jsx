          ...
          <div className="panel" key={t.key} style={{ marginTop: 14 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', gap: 10, flexWrap: 'wrap' }}>
              <h3 className="sheet-h3" style={{ margin: 0 }}>
                <span style={{ fontSize: '.7rem', padding: '2px 7px', borderRadius: 20, background: isDuo ? 'var(--warn,#c99)' : 'var(--accent,#b98b50)', color: '#fff', marginRight: 8, verticalAlign: 'middle' }}>{isDuo ? 'DÚO' : 'TRÍO'}</span>
