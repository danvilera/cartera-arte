...
export const WORKS = [
  ...
  },
  {
    ...
    ref: 'Bloch 281 · Baer 429 · ej. 5/50 · 23,8×29,9 cm · 8.000 € + IVA (≈ 9.680 €)',
    comp: 'Aguafuerte de 1934 (época de la Suite Vollard). Firmado ~6.000–20.000 €; sin firmar, bastante menos.',
    def: { signed: '?', numbered: 'si', catalogue: 'si', cert: '?' },
    note: 'Picasso de 1934, tema taurino. La ficha no aclara la firma (y la nota “347/195” es rara para una obra de 1934): confirma que va firmada a lápiz y la edición exacta. Firmado, buen precio; sin firma, cara.',
    desc: 'Aguafuerte de línea de 1934, escena de tauromaquia (mujer torero, caballo y toro moribundo), de los años de la Suite Vollard.',
    detail: [
      ['Fecha', '22 de junio de 1934'], ['Técnica', 'Aguafuerte'], ['Dimensiones', '23,8 × 29,9 cm'],
      ['Edición', '5/50'], ['Catálogo', 'Bloch 281 · Baer 429'], ['Precio', '8.000 € + IVA (≈ 9.680 €)'], ['Galería', 'Joan Gaspar'],
    ],
  },
  {
